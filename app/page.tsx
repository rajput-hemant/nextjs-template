                    ...
                    {(Object.keys(packageManagers) as PackageManagers[]).map(
                      (pm, i) => (
                        <button
                          ...
                          className="m-0.5 w-20 cursor-pointer rounded-md px-3 py-0.5 ring-zinc-600 outline-none hover:bg-zinc-700/50 hover:text-green-500 focus:ring-2"
                        >
                          {pm}
                        </button>
                      ),
